...
sudo flatpak remote-add --if-not-exists https://dl.flathub.org/repo/flathub.flatpakrepo
flatpak install flathub io.github.kolunmi.Bazaar com.rafaelmardojai.Blanket org.pulseaudio.pavucontrol io.github.diegopvlk.Dosage \
com.mattjakeman.ExtensionManager com.heroicgameslauncher.hgl io.itch.itch md.obsidian.Obsidian io.github.kriptolix.Poliedros \
...
gsettings set org.gnome.desktop.background picture-uri file:///~/.wallpaper/wallpaper.png
gsettings set org.gnome.desktop.background picture-uri-dark file:///~/.wallpaper/wallpaper.png
